...
public abstract class RegularLevel extends Level {
	...
	private static final float[] SIZE_MODIFIER = {.5f,.7f}; // range of values
	...
	protected void createItems() {
		...
		if (Dungeon.hero.hasTalent(Talent.CACHED_RATIONS,Talent.ROYAL_PRIVILEGE)){
			...
			if (dropped.count() < 2 + 2*Dungeon.hero.pointsInTalents(Talent.CACHED_RATIONS,Talent.ROYAL_PRIVILEGE)){
				int cell;
				do {
