...
public enum Talent {
	...
	//Mage T1
	ENERGIZING_MEAL_I(32), SCHOLARS_INTUITION(33), TESTED_HYPOTHESIS(34), BACKUP_BARRIER(35),
	//Mage T2
	...
	//Battlemage T3
	EMPOWERED_STRIKE(43, 3), MYSTICAL_CHARGE(44, 3), EXCESS_CHARGE(45, 3), WAR_MAGE(38,3),
	//Warlock T3
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case GLADIATOR:
				...
				break;
			case BATTLEMAGE:
				Collections.addAll(tierTalents, WAR_MAGE, EMPOWERED_STRIKE, MYSTICAL_CHARGE, EXCESS_CHARGE);
				break;
			case WARLOCK:
